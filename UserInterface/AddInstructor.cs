// With this form we can add a new instructor to our database
...
namespace UserInterface
{
    public partial class AddInstructor : Form
    {
        ...
        public static AddInstructor instance;
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "add_instructor";
                cmd.CommandType = CommandType.StoredProcedure;

                // Giving the arguments for the stored procedure from the textboxes
                cmd.Parameters.AddWithValue("@instructor_id", textBox1.Text);
                cmd.Parameters["@instructor_id"].Direction = ParameterDirection.Input;
                ...
                cmd.Parameters.AddWithValue("@office_number", textBox4.Text);
                cmd.Parameters["@office_number"].Direction = ParameterDirection.Input;
        ...
        private void AddInstructor_FormClosing(object sender, FormClosingEventArgs e)
        {
            Dashboard form = new Dashboard();
            form.Show();
        }
