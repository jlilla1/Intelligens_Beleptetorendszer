...
def main_app(name):
        ...
        # if we would like to see the picture that the camera captures during identification than change it to 1
        showCameraPicture = 0
        ...
        while True:
            ...
            if (showCameraPicture):
                cv2.imshow("image", frame)
            

            if cv2.waitKey(20) & captureCount >= 100:
